...
import { REDIS_CLIENT } from './redis.symbol';
import { IRedisManager } from './redis.manager.interface';

@Injectable()
export class RedisManager implements IRedisManager {
  constructor(@Inject(REDIS_CLIENT) private readonly redisClient: Cluster) {
    this.monitor();
  }
